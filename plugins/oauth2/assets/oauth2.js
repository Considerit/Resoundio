...
hd.registerPlugin('OAuth2', function(key, shadow_root, initial_props) {
    ...
    function initiate_oauth2_flow(ev) {
        ...
        authorizationUrl = oauthProviderUrl + 
            '?client_id=' + clientId + 
...
// HTML and CSS from https://developers.google.com/identity/branding-guidelines
google_login_button_html = `
